...
<html>
    ...
    <body class="">
        <div class="logo">
            <h4><a href="<?php echo Uri::base(); ?>">BuffoHero <strong>CMS</strong></a></h4>
        </div>
            ...
            <header class="page-header">
                <div class="navbar">
                    <ul class="nav navbar-nav navbar-right pull-right">
                        ...
                        <li class="hidden-xs"><a href="<?php echo Uri::create('user/logout'); ?>"><i class="fa fa-sign-out"></i></a></li>
                    </ul>
                </div>
            </header>
        ...
        <!-- page specific -->
        <script src="<?php echo Fuel\Core\Uri::base(); ?>public/assets/js/index.js"></script>
