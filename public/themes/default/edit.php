    ...
    <body class="">
        ...
        <div class="wrap">
            ...
            <div class="content container">
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="widget">
                            ...
                            <?php foreach($breadcrumb as $b){ ?>
                                <?php if($b['active']) { ?>
                                <li class="active"><i class="fa <?php echo $b['icon']; ?>"></i> <?php echo $b['title']; ?></li>
                                <?php } else { ?>
                                <li><a href="<?php echo $b['link']; ?>"><i class="fa <?php echo $b['icon']; ?>"></i> <?php echo $b['title']; ?></a></li>
                                <?php } ?>
                            <?php } ?>
                            </ol>
                        </section>
                ...
                <?php } ?>
                <div class="row">
                    <div class="col-md-<?php echo (isset($partials['right']))?"8":"12"; ?>" id="left"><?php echo $partials['left']; ?></div>
                    <?php if(isset($partials['right'])) { ?>
                    <div class="col-md-4" id="right"><?php echo isset($partials['right'])?$partials['right']:""; ?></div>
                    <?php } ?>
                </div>
            </div>
        </div>
        ...
        <!-- TinyMCE -->
        <script src="<?php echo Fuel\Core\Uri::base(); ?>public/assets/lib/tinymce/tinymce.min.js"></script>
        
        <!-- page specific -->
        <script src="<?php echo Fuel\Core\Uri::base(); ?>public/assets/js/form_common.js"></script>
        <?php if(isset($page_specific_js)) { ?><script src="<?php echo Fuel\Core\Uri::base(); ?>public/assets/js/<?php echo $page_specific_js; ?>"></script><?php } ?>
