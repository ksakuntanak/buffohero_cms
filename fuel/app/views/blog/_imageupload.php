...
<section class="widget">
    <header>
        <h4><i class="fa fa-upload"></i> อัพโหลดไฟล์ภาพประกอบเนื้อหาบล็อก</h4>
    </header>
    <div class="body">
        <p>ผู้ใช้งานต้องอัพโหลดไฟล์ภาพที่ต้องการขึ้นสู่ระบบก่อน จึงจะสามารถนำภาพไปแทรกในเนื้อหาบล็อกได้</p>
        <p class="blog-block">* รองรับไฟล์ .jpg หรือ .png เท่านั้น</p>
        <form id="photo_upload" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <span class="btn btn-default fileinput-button" style="float:none;">
                    ...
                    <input id="photo-file-1" type="file" name="blog_photo_file[]" accept="image/*" />
                </span>
            </div>
            <div class="form-group">
                <span class="btn btn-default fileinput-button" style="float:none;">
                    ...
                    <input id="photo-file-2" type="file" name="blog_photo_file[]" accept="image/*" />
                </span>
            </div>
            <div class="form-group">
                <span class="btn btn-default fileinput-button" style="float:none;">
                    ...
                    <input id="photo-file-3" type="file" name="blog_photo_file[]" accept="image/*" />
                </span>
            </div>
            <div class="form-group">
                <span class="btn btn-default fileinput-button" style="float:none;">
                    ...
                    <input id="photo-file-4" type="file" name="blog_photo_file[]" accept="image/*" />
                </span>
            </div>
            <div class="form-group">
                <span class="btn btn-default fileinput-button" style="float:none;">
                    ...
                    <input id="photo-file-5" type="file" name="blog_photo_file[]" accept="image/*" />
                </span>
            </div>
