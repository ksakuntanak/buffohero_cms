        ...
        <?php foreach ($employees['rows'] as $item): ?>
            <tr>
                ...
                <td>
                    ...
                    <?php echo Html::anchor('employee/delete/' . $item['id'], '<i class="fa fa-trash-o"></i> ลบผู้ใช้งาน', array('onclick' => "return confirm('Employee #".$item['id']." will be deleted. Continue?')")); ?>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
